...
class RestaurantTest extends TestCase
{
    ...
    public function test_non_admin_user_cannot_access_admin_restaurants_index()
    {
    ...
    public function test_guest_cannot_access_admin_restaurants_store()
    {
        ...
        $response = $this->get(route('admin.restaurants.store'), $restaurant_data);
    ...
    public function test_user_cannot_access_admin_restaurants_store()
    {
        ...
        $response = $this->actingAs($user)->get(route('admin.restaurants.store'), $restaurant_data);
    ...
    public function test_guest_cannot_access_admin_restaurants_update()
    {
        ...
        $response = $this->get(route('admin.restaurants.update', $old_restaurant), $new_restaurant_data);
    ...
    public function test_user_cannot_access_admin_restaurants_update()
    {
        ...
        $response = $this->actingAs($user)->get(route('admin.restaurants.update', $old_restaurant), $new_restaurant_data);
