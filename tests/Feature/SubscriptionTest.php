...
class SubscriptionTest extends TestCase
{
    ...
    public function test_free_user_can_access_subscription_edit()
    {
        $user = User::factory()->create();
    ...
    public function test_premium_user_cannot_access_subscription_edit()
    {
        $user = User::factory()->create();
        $user->newSubscription('premium_plan', 'price_1RdwlxDfDiYheqQcIIfxbFu6')->create('pm_card_visa');
    ...
    public function test_free_user_can_access_subscription_update()
    {
        $user = User::factory()->create();
    ...
    public function test_premium_user_cannot_access_subscription_update()
    {
        $user = User::factory()->create();
        $user->newSubscription('premium_plan', 'price_1RdwlxDfDiYheqQcIIfxbFu6')->create('pm_card_visa');
